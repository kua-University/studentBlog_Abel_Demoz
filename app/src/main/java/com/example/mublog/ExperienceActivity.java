...
public class ExperienceActivity extends AppCompatActivity implements PostAdapter.OnItemClickListener{
    ...
    private void fetchPosts() {
        db.collection("posts")
                .whereEqualTo("category", "Experience") // Fetch posts for the "Experience" category
                .get()
