...
public class ScholarActivity extends AppCompatActivity implements PostAdapter.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scholarship); // Set the layout for this activity
    ...
    private void fetchPosts() {
        db.collection("posts")
                .whereEqualTo("category", "Scholarship") // Fetch posts for the "Experience" category
                .get()
