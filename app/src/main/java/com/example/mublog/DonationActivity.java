...
public class DonationActivity extends AppCompatActivity implements PostAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_donation); // Set the layout for this activity
        ...
        postAdapter = new PostAdapter(postList, this); // Pass 'this' as the listener
        recyclerView.setAdapter(postAdapter);

        // Fetch posts for the "Donation" category
        fetchPosts();
    }

    private void fetchPosts() {
        db.collection("posts")
                .whereEqualTo("category", "Donation") // Fetch posts for the "Donation" category
                .get()
