...
public class CampusLife extends AppCompatActivity implements PostAdapter.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_schoollife); // Set the layout for this activity
    ...
    private void fetchPosts() {
        db.collection("posts")
                .whereEqualTo("category", "Campus life") // Fetch posts for the "Experience" category
                .get()
