...
public class MentorShipActivity extends AppCompatActivity implements PostAdapter.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mentorship); // Set the layout for this activity
    ...
    private void fetchPosts() {
        db.collection("posts")
                .whereEqualTo("category", "Mentorship") // Fetch posts for the "Experience" category
                .get()
