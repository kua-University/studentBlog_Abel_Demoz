...
public class ResearchActivity extends AppCompatActivity implements PostAdapter.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_research); // Set the layout for this activity
    ...
    private void fetchPosts() {
        db.collection("posts")
                .whereEqualTo("category", "Academic / Research") // Fetch posts for the "Experience" category
                .get()
